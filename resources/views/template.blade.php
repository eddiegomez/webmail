...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('template/bootstrap/css/bootstrap.min.css')?>"> 
    <link rel="stylesheet" href="<?php echo asset('template/font-awesome/css/font-awesome.min.css')?>">

    <script type="text/javascript" src="<?php echo asset('template/js/jquery-1.10.2.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo asset('template/bootstrap/js/bootstrap.min.js')?>""></script>
</head>
<body>
