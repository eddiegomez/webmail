        ...
        <div class="row">
          ...
          >
            <div class="card" style>
              <img
                :src="'/imagens/artigos/' + artigo.foto"
                class
                style="height: 350px"
              />
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    {{ artigo.quantidade }} {{ artigo.tipo_qtd }}
                  </div>
                </div>
                <div class="row">
                ...
                <center>
                  ...
                  <a href="#">
                    <button
                      type="submit"
                      @click="apagar_artigo(artigo.idartigo)"
                      class="btn curved btn-danger"
                    >
          ...
          <form @submit.prevent="editmode ? actualizar() : registar()" >
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <div class="form-group">
                    <label for="photo" class="col-sm-10 text-muted"
                      >Fotografia</label
                    >
                    <input
                      type="file"
            ...
            <div class="modal-footer">
              ...
              <a href="#" @click="editModal(artigo)" class>
                <button v-show="editmode" class="btn curved btn-success">
                  Actualizar
                </button>
              </a>
              <button
